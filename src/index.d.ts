 ...
 */
declare type mPath = Array<string>;

/**
 * The index of an entity in the game world.
 */
declare type mEntityID = number;

/**
 * The index of a user in an event.
 */
declare type mUserID = number;
 ...
 */
declare type mVector = Array<number>;
...
declare namespace Duktape {
  /**
   * Handles the error creation
   * @param error The thrown error
   */
  function errCreate(error: Error): void;
}
...
declare namespace UI {
   ...
   */
  function RegisterCallback(path: mPath): void;
   ...
   */
  function UpdateList(path: mPath, list: Array<string>): void;
   ...
   */
  function RemoveItem(path: mPath): void;
   ...
   */
  function GetHotkey(path: mPath): number;
   ...
   */
  function SetHotkeyState(path: mPath, state: string): void;
   ...
   */
  function GetHotkeyState(path: mPath): string;
   ...
   */
  function ToggleHotkey(path: mPath): void;
   ...
   */
  function SetColor(path: mPath, color: Array<number>): void;
   ...
   */
  function AddSubTab(path: mPath, name: string): mPath;
   ...
   */
  function AddTextbox(path: mPath, name: string): mPath;
   ...
   */
  function AddColorPicker(path: mPath, name: string): mPath;
   ...
   */
  function AddCheckbox(path: mPath, name: string): mPath;
   ...
   */
  function SetValue(path: mPath, value: number): mPath;
   ...
   */
  function GetValue(path: mPath): number;
   ...
   */
  function GetString(path: mPath): string;
   ...
   */
  function GetColor(path: mPath): Array<number>;
   ...
   */
  function GetChildren(path: mPath): Array<string>;
   ...
   */
  function SetEnabled(path: mPath, visible: number): void;
}
...
declare namespace Entity {
   ...
   */
  function GetEntityFromUserID(index: mUserID): mEntityID;
   ...
   */
  function IsTeammate(index: mEntityID): boolean;
   ...
   */
  function IsEnemy(index: mEntityID): boolean;
   ...
   */
  function IsLocalPlayer(index: mEntityID): boolean;
   ...
   */
  function IsValid(index: mEntityID): boolean;
   ...
   */
  function IsAlive(index: mEntityID): boolean;
   ...
   */
  function IsDormant(index: mEntityID): boolean;
   ...
   */
  function IsBot(index: mEntityID): boolean;
   ...
   */
  function GetClassID(index: mEntityID): number;
   ...
   */
  function GetClassName(index: mEntityID): string;
   ...
   */
  function GetName(index: mEntityID): string;
   ...
   */
  function GetRenderOrigin(index: mEntityID): mVector;
   ...
   */
  function GetEyePosition(index: mEntityID): mVector;
   ...
   */
  function GetWeapon(index: mEntityID): mEntityID;
  ...
  /**
   * @param {mEntityID} index The entity's index
   ...
   */
  function GetRenderBox(index: mEntityID): Array<number>;
   ...
   */
  function GetCCSWeaponInfo(index: mEntityID): Object;
   ...
   */
  function DisableESP(index: mEntityID): void;
   ...
   */
  function GetSteamID(index: mEntityID): number;
  ...
  function GetAnimationLayer(
    index: mEntityID,
    layer: AnimationLayerIndex
  ): AnimationLayer;
  
  /**
   * Overrides the visuals opacity for this specific entity.
   * @param index The player's index
   * @param opacity The desired opacity. Ranges from 0 to 255.
   */
  function OverrideESPOpacity(
    index: mEntityID,
    opacity: number
  ): void;
}
...
declare namespace Render {
   ...
   * @param {mVector} point The 3D point
   * @see {@link https://www.onetap.com/resources/39/| Official Onetap Documentation}
   */
  function WorldToScreen(point: mVector): Array<number>;
...
declare namespace Trace {
   ...
   */
  function Smoke(from: mVector, to: mVector): number;
}
...
declare namespace UserCMD {
   ...
   */
  function SetViewAngles(angles: mVector, silent: boolean): void;
...
declare namespace Local {
   ...
   */
  function GetViewAngles(): mVector;
   ...
   */
  function GetCameraAngles(): mVector;
   ...
   */
  function GetCameraPosition(): mVector;
   ...
   */
  function IsDormantTo(index: mEntityID): boolean;
   ...
   * @see {@link https://www.onetap.com/resources/15/| Official Onetap Documentation}
   */
  function SetViewAngles(angles: mVector): void;
   ...
   */
  function SetCameraAngles(angles: mVector): void;
   ...
   */
  function SetCameraPosition(point: mVector): void;
...
declare namespace World {
   ...
   * @param {mVector} position The position in the world to spawn the lightning strike.
...
declare namespace Ragebot {
   ...
   */
  function GetTargets(): Array<mEntityID>;
   ...
   */
  function ForceTarget(index: mEntityID): void;
   ...
   */
  function IgnoreTarget(index: mEntityID): void;
   ...
   */
  function IgnoreTargetHitbox(index: mEntityID, hitbox: number): void;
   ...
   */
  function ForceTargetSafety(index: mEntityID): void;
  ...
  /**
   * Forces the ragebot to override the pointscale of every target's head.
   * @param pointscale The desired pointscale.
   */
  function ForceTargetHeadPointscale(pointscale: number): void;

  /**
   * Forces the ragebot to override the pointscale of every target's body.
   * @param pointscale The desired pointscale
   */
  function ForceTargetBodyPointscale(pointscale: number): void;
}
